...
import { Grinch } from "../world/gameobjects/entities/enemies/grinch.js";
import { Cookie } from "../world/gameobjects/collectables/cookie.js";
import { Gift } from "../world/gameobjects/collectables/gift.js";
import { Tree } from "../world/gameobjects/collectables/tree.js";
            ...
            for (let y = 0; y < layersY; y++) {
                ...
                for (let x = 0; x < layersX; x++) {
                    ...
                    if (tileIndex === Tile.SPAWN_LOCATION) {
                        ...
                        // regular tile
                        const tile = TileFactory.createTile(tileIndex, isSolid, tileWorldPosition);
