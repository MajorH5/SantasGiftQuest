...
export const Sounds = (function () {
    return class Sounds {
        ...
        static SND_STEP = new AudioSource('/public/assets/sounds/snd_step.ogg', Sounds.sfxContext);
        static SND_JUMP = new AudioSource('/public/assets/sounds/snd_jump.ogg', Sounds.sfxContext);
        static SND_GIFT_COLLECT = new AudioSource('/public/assets/sounds/snd_gift_collect.ogg', Sounds.sfxContext);
        static SND_DAMAGE = new AudioSource('/public/assets/sounds/snd_damage.ogg', Sounds.sfxContext);
        static SND_SMOOSH = new AudioSource('/public/assets/sounds/snd_smoosh.ogg', Sounds.sfxContext);
        static SND_BUTTON_SELECT = new AudioSource('/public/assets/sounds/snd_button_select.ogg', Sounds.sfxContext);
        static SND_IMPACT = new AudioSource('/public/assets/sounds/snd_impact.ogg', Sounds.sfxContext);
        static SND_BUTTON_PRESS = new AudioSource('/public/assets/sounds/snd_button_press.ogg', Sounds.sfxContext);
        static SND_EXPLOSION = new AudioSource('/public/assets/sounds/snd_explosion.ogg', Sounds.sfxContext);
        static SND_PROJECTILE_HIT = new AudioSource('/public/assets/sounds/snd_projectile_hit.wav', Sounds.sfxContext);
        static SND_FLAME = new AudioSource('/public/assets/sounds/snd_flame.ogg', Sounds.sfxContext);
        static SND_DEATH = new AudioSource('/public/assets/sounds/snd_death.wav', Sounds.sfxContext);
        static SND_SNOWMAN_BOSS_CHARGE = new AudioSource('/public/assets/sounds/snd_snowman_boss_charge.ogg', Sounds.sfxContext);
        static SND_SNOWMAN_BOSS_BUST = new AudioSource('/public/assets/sounds/snd_snowman_boss_bust.ogg', Sounds.sfxContext);
        static SND_COOKIE = new AudioSource('/public/assets/sounds/snd_cookie.wav', Sounds.sfxContext);
        static SND_TREE_COLLECT = new AudioSource('/public/assets/sounds/snd_tree_collect.ogg', Sounds.sfxContext);
        static SND_SCORE_IMPACT = new AudioSource('/public/assets/sounds/snd_score_impact.ogg', Sounds.sfxContext);

        static SND_THEME = new AudioSource('/public/assets/sounds/snd_theme.mp3', Sounds.musicContext);
        static SND_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_theme_stinger.mp3', Sounds.musicContext);
        static SND_GRINCH_BOSS_THEME = new AudioSource('/public/assets/sounds/snd_grinch_boss_theme.mp3', Sounds.musicContext);
        static SND_GRINCH_BOSS_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_grinch_boss_theme_stinger.mp3', Sounds.musicContext);
        static SND_SNOWMAN_BOSS_THEME = new AudioSource('/public/assets/sounds/snd_snowman_boss_theme.mp3', Sounds.musicContext);
        static SND_SNOWMAN_BOSS_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_snowman_boss_theme_stinger.mp3', Sounds.musicContext);
        static SND_NIGHT_THEME = new AudioSource('/public/assets/sounds/snd_night_theme.mp3', Sounds.musicContext);
        static SND_NIGHT_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_night_theme_stinger.mp3', Sounds.musicContext);
        static SND_TITLE_THEME = new AudioSource('/public/assets/sounds/snd_title_theme.mp3', Sounds.musicContext);
        static SND_TITLE_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_title_theme_stinger.mp3', Sounds.musicContext);
        static SND_WORKSHOP_THEME = new AudioSource('/public/assets/sounds/snd_workshop_theme.mp3', Sounds.musicContext);
        static SND_WORKSHOP_THEME_STINGER = new AudioSource('/public/assets/sounds/snd_workshop_theme_stinger.mp3', Sounds.musicContext);
