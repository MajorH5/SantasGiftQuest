...
export const Sprite = (function () {
    return class Sprite {
        ...
        static IMG_ICONS = '/assets/images/icons.png';
        static IMG_CROSSHAIR_CLOSED = '/assets/images/crosshair_closed.png';
        static IMG_CROSSHAIR_OPEN = '/assets/images/crosshair_open.png';
        static IMG_PANEL = '/assets/images/panel.png';
