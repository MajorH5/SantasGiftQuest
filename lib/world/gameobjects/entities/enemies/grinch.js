...
import { BehaviorGrinch } from '/lib/ai/behaviors/behaviorGrinch.js';
...
import { Camera } from '/lib/world/camera.js';
    ...
    return class Grinch extends Entity {
        ...
        update (deltaTime) {
            ...
            if (this.completedCutscene && !this.isDead()) {
                if (this.health / this.maxHealth > 0.25 || Math.sin(Date.now() * 0.001) > 0.5) {
