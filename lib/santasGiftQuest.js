...
import { UIJoystick } from './ui/features/uiJoystick.js';
import { UIEditorScreen } from './ui/screens/uiEditorScreen.js';
...
export const SantasGiftQuest = (function () {
    return class SantasGiftQuest {
        ...
        constructor (canvasDom) {
            ...
            this.editorScreen = new UIEditorScreen();
        ...
        createTitleScreen () {
            ...
            titleScreen.onStart.listen(async () => {
                ...
                this.levelSelectScreen.refreshStageStates();
                this.levelSelectScreen.setPageIndex(0);
            ...
            titleScreen.onEditor.listen(async () => {
                if (this.transition.isTransitioning) {
                    return;
                }
                ...
                this.editorScreen.reset();
                this.editorScreen.visible = true;
        ...
        async init () {
            ...
            document.addEventListener('keydown', (e) => {
                ...
                switch (key) {
                    ...
                    case SantasGiftQuest.STAGE_RESET_KEY:
                        ...
                        world.crossFade = 0;
                        world.loadStage(world.stage, true);
            ...
            // (new UIJoystick()).parentTo(this.titleScreen);
        ...
        async returnToMenu () {
            ...
            await this.titleScreen.loadRandomStage();
            this.titleScreen.visible = true;
