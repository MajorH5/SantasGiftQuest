...
export const UILevelPage = (function () {
    return class UILevelPage extends UIBase {
        ...
        addStage (stageNumber, isLocked = true) {
            const buttonScale = 4;
            ...
            const lockImage = new UIImage(Sprite.IMG_ICONS, {
                imageRectSize: new Vector2(16, 16),
                imageRectOffset: new Vector2(4, 1).scale(16),
                size: new Vector2(16, 16).scale(buttonScale),
                positionScale: new Vector2(0.5, 0.5),
                pivot: new Vector2(0.5, 0.5),
                visible: isLocked
            });
            lockImage.parentTo(stageContainer);
