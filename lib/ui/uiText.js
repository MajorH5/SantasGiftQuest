...
export const UIText = (function () {
    return class UIText extends UIBase {
        static FONT_PRESS_START_2P = new FontFace('PressStart2P', 'url(../assets/fonts/PressStart2P-Regular.ttf)');
        static GOTHAM = new FontFace('Gotham', 'url(../assets/fonts/Gotham-Bold.ttf)');
