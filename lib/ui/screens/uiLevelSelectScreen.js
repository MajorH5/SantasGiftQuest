...
import { Easing } from "/lib/misc/easing.js";
...
export const UILevelSelectScreen = (function () {
    return class UILevelSelectScreen extends UIBase {
        constructor () {
            ...
            this.page1.parentTo(this.pageContainer);

            this.page2 = new UILevelPage();
            this.page2.addStage(12);
            this.page2.addStage(13);
            this.page2.addStage(14);
            this.page2.addStage(15);
            this.page2.addStage(16);
            this.page2.addStage(17);
            this.page2.addStage(18);
            this.page2.addStage(19);
            this.page2.addStage(20);
            this.page2.addStage(21);
            this.page2.addStage(22);
            this.page2.visible = false;
            this.page2.parentTo(this.pageContainer);

            this.page3 = new UILevelPage();
            this.page3.addStage(12);
            this.page3.addStage(13);
            this.page3.addStage(14);
            this.page3.addStage(15);
            this.page3.addStage(16);
            this.page3.addStage(17);
            this.page3.addStage(18);
            this.page3.addStage(19);
            this.page3.addStage(20);
            this.page3.addStage(21);
            this.page3.addStage(22);
            this.page3.visible = false;
            this.page3.parentTo(this.pageContainer);
