...
export const Sprite = (function () {
    return class Sprite {
        ...
        static IMG_WINTER_BACKGROUND_1 = Constants.ORIGIN + '/assets/images/background/winter_background_1.png';
        static IMG_WINTER_BACKGROUND_2 = Constants.ORIGIN + '/assets/images/background/winter_background_2.png';
        ...
        static async preloadAll () {
            return Promise.all([
                ...
                Sprite.getImage(Sprite.IMG_WINTER_BACKGROUND_1),
                Sprite.getImage(Sprite.IMG_WINTER_BACKGROUND_2)
            ]);
        }
